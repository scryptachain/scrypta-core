module.exports = class ScryptaDB {
    ...
    loadBrowserDB(){
        ...
        return new Promise(response => {
            const collections = ["wallet","sxidcache","usxocache","txidcache","utxocache","messages","checksums"]
    ...
    loadNodeDB(){
        ...
        return new Promise(response => {
            db.dir = './db';
            const collections = ["wallet","sxidcache","usxocache","txidcache","utxocache","checksums"]
