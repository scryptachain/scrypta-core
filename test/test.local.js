...
describe('Addresses', async function() {
    it('Should create a contract request', async function(){
        ...
        let request = await scrypta.createContractRequest(address.walletstore, '123456', { contract: "LgSAtP3gPURByanZSM32kfEu9C1uyQ6Kfg", function: "index", params: "LgSAtP3gPURByanZSM32kfEu9C1uyQ6Kfg" })
